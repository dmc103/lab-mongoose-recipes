...
mongoose
  ...
  .then(() => {
    ...
    return Recipe.insertMany(newRecipes);

  })

  .then ((addedRecipes) => {
    console.log(`New Recipes are added in the databse`);
    addedRecipes.forEach((recipe) => {
      console.log(`New recipe called: ${recipe.title}`);
    });
  ...
  .then ((UpdatedRecipe) => {
    ...
    console.log(`Updated Recipe is: ${UpdatedRecipe.title}, duration: ${UpdatedRecipe.duration}`);
